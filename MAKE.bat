...
pushd assimp\.build
cmake .. -DCMAKE_BUILD_TYPE=Release -DUSE_STATIC_CRT=ON -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded -DCMAKE_POLICY_DEFAULT_CMP0091=NEW && cmake --build . --config Release --verbose && rem (make || msbuild assimp.sln -m -p:Configuration=Release)
popd
...
cl ass2iqe.c -I. -I ..\..\code\3rd -I assimp\include assimp-vc14?-mt.lib /O2 /Oy /MT /DNDEBUG
